...
// 함수 안에서 console.log(this) 할 경우 undefined 출력
const completeFunction = manager.completeProgramWithFunction;
// completeFunction('기초 펫 돌봄');

// 화살표 함수로 이수 처리 (this 바인딩 확인)
// manager.completeProgramWithArrowFunction('건강관리');

// 함수 안에서 console.log(this) 할 경우 manager class 출력
const completeArrowFunction = manager.completeProgramWithArrowFunction;
completeArrowFunction('건강관리');
